...
INSERT INTO activity_field_definition (activity_id, field_key, label, field_type, unit, dashboard_metrics) VALUES
  ('44444444-4444-4444-4444-444444444444', 'amount', 'Amount', 'number', 'ml', '["total", "average", "trend"]'),
  ('44444444-4444-4444-4444-444444444444', 'method', 'Feeding method', 'select', NULL, '["count"]'),
  ('55555555-5555-5555-5555-555555555555', 'type', 'Diaper type', 'select', NULL, '["count"]');
INSERT INTO activity_log (child_id, activity_id, event_time, event_timezone, field_values, note, created_by) VALUES
  ('33333333-3333-3333-3333-333333333333', '44444444-4444-4444-4444-444444444444', now() - interval '55 minutes', 'Asia/Jerusalem', '{"amount":120,"method":"Bottle"}', 'Finished comfortably', '22222222-2222-2222-2222-222222222222'),
  ...
  ('33333333-3333-3333-3333-333333333333', '44444444-4444-4444-4444-444444444444', now() - interval '3 hours 40 minutes', 'Asia/Jerusalem', '{"amount":95,"method":"Bottle"}', NULL, '22222222-2222-2222-2222-222222222222');
